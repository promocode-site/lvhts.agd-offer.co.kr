# 블로그 폴더 설명 (lvhts.agd-offer.co.kr)
...
주소는 `https://lvhts.agd-offer.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://lvhts.agd-offer.co.kr/blog/agoda-coupon/ |
